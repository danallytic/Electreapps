...
# (autor:Luke Harold Miles, code at https://gist.github.com/qpwo/272df112928391b2c83a3b67732a5c25)
def simple_cycles(G):
...
def electre_ii(dataset, W, c_minus = 0.65, c_zero = 0.75, c_plus = 0.85, d_minus = 0.25, d_plus = 0.50, graph = False):
    ...
    if (graph == True):
        po_ranking(rank_P)
    return concordance, discordance, dominance_s, dominance_w, rank_D, rank_A, rank_M, rank_P,plt
